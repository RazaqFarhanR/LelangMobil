...
<head>
    ...
    <div style= "background-image: url(./gambar/background_page.png); height:1000px">
</head>
<body>
    <?php
    include "navbar.php";
    ...
    <div class="container col-md-10">
        <div class="card">
            <div class="card-header">
                <h1 style="text-align:center">Lelang</h1>
                <form method="POST" action="lelang.php" class="d-flex">
            ...
            <!-- <a href="tambah_barang.php" type="button" class="btn btn-warning">Tambah Barang</a> -->
            </div>
        </div>
    </div>
