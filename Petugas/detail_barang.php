                                ...
                                <table class="table table-hover table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <td><input type="number" name="harga_tawar" value="1"> x 10,000,000 ,</td>
                                        </tr>
                                        <tr>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                if ($data_barang['status'] == 'ditutup'){
                                    ...
                                    SELECT lelang.id_peserta, lelang.harga, peserta.nama 
                                    FROM lelang
                                    JOIN peserta ON peserta.id_peserta = lelang.id_peserta 
                                    ORDER BY harga DESC");
