<?php
    ...
    $jumlah_harga_tawar = $_POST['harga'] + $harga_tawar;
    $harga = $_POST['harga'];

        if ($jumlah_harga_tawar <= $harga) {
            echo "<script>alert('Tawaran anda dibawah harga lelang');location.href='lihat_barang.php?id_barang=$id_barang'</script>";
        }else {
